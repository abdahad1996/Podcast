...
class MainTabBarController : UITabBarController{
    ...
    fileprivate func setupViewControllers(){
        ...
        viewControllers = [
            generateNavigationViewController(with: PodcastSearchController(), title: "search", image:UIImage(named:"search")! ),
            generateNavigationViewController(with: ViewController(), title: "favourties", image:UIImage(named:"favorites")! ),
